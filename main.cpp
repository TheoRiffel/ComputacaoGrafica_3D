...
int main(void){
    ...
    textures.push_back({"objetos/cabana/WoodCabinDif.jpg",GL_RGB});
    textures.push_back({"objetos/cabana/WoodCabinDif.jpg",GL_RGB});
    mesh cabana(program, "objetos/cabana/cabana.obj", textures, v_vertices, v_normals, v_uvs);
    textures.clear();

    //Criacao do modelo da malha do terreno externo de areia com sua respectiva textura
    textures.push_back({"objetos/terreno/areia.jpg", GL_RGB});
    mesh terreno1(program, "objetos/terreno/terreno.obj", textures, v_vertices, v_normals, v_uvs);
    textures.clear();

    textures.push_back({"objetos/terreno/grama.jpg", GL_RGB});
    mesh terreno2(program, "objetos/terreno/terreno.obj", textures, v_vertices, v_normals, v_uvs);
    textures.clear();

    textures.push_back({"objetos/gato/Cat_diffuse.jpg", GL_RGB});
    mesh gatinho(program, "objetos/gato/gatinho.obj", textures, v_vertices, v_normals, v_uvs);
    textures.clear();

    textures.push_back({"objetos/terreno/pedras.jpg", GL_RGB});
    ...
    textures.push_back({"objetos/terreno/noite_estrelada.jpg", GL_RGB});
    mesh ceu(program, "objetos/terreno/terreno.obj", textures, v_vertices, v_normals, v_uvs);
    textures.clear();
    ...
    {   
        ...
        sofa.scale(0.01f, 0.01f, 0.01f);
        sofa.translate(-150.0f, 100.0f, 60.0f);
        sofa.rotate(-90, X);
        sofa.rotate(90, Z);
        sofa.update();
